<form action="" method="GET" id="search-form" class="">
    <div class="card-header header-elements-sm-inline">
        <div class="card-title header-elements-inline">
            <input type="text" name="search" value="{{ Request::get('search') }}" class="form-control input-solid" placeholder="Search for action...">
            <button type="submit" class="btn bg-indigo btn-icon ml-2 mr-2 legitRipple">
                <i class="icon-search4"></i>
            </button>
            <a href="{{ isset($adminView) ? route('activity.index') : route('profile.activity') }}" title="Refresh the page">
