<div class="navbar navbar-expand-md navbar-dark bg-indigo navbar-static">
    ...
    <div class="collapse navbar-collapse" id="navbar-mobile">
        ...
        <span class="navbar-text ml-md-3">
			...
			{{ userSalutation() }}, {{ auth()->user()->present()->nameOrEmail }}!
        </span>
        ...
        <ul class="navbar-nav ml-md-auto">
            <li class="nav-item dropdown">
                <a href="#" class="navbar-nav-link dropdown-toggle" data-toggle="dropdown">
                    ...
                    <span class="badge badge-pill bg-pink-300 position-static ml-auto ml-xl-1">28</span>
                </a>
            ...
            <li class="nav-item dropdown">
                <a href="#" class="navbar-nav-link dropdown-toggle" data-toggle="dropdown">
                    ...
                    <span class="d-xl-none ml-2">Activities</span>
                    <span class="badge badge-pill bg-green-400 position-static ml-auto mr-xl-1">28</span>
                </a>
            ...
            <li class="nav-item dropdown">
                ...
                <div class="dropdown-menu dropdown-menu-right dropdown-content wmin-md-350">
                    ...
                    <div class="dropdown-content-footer bg-light">
                        <a href="#" class="font-size-sm line-height-sm text-uppercase font-weight-semibold text-grey mr-auto">All activities</a>
                        <div>
                            <a href="#" class="text-grey" data-popup="tooltip" title="Clear list"><i class="icon-checkmark3"></i></a>
                            <a href="#" class="text-grey ml-2" data-popup="tooltip" title="Settings"><i class="icon-gear"></i></a>
                        </div>
