...
<script src="{{ asset('backend/global_assets/js/plugins/extensions/jquery_ui/core.min.js') }}"></script>
...
<script src="{{ asset('backend/global_assets/js/demo_pages/table_responsive.js') }}"></script>
    ...
    <script src="{{ asset('backend/global_assets/js/demo_pages/colors_indigo.js') }}"></script>
